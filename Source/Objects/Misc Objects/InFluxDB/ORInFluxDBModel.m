...
- (void) updateDiskInfo
{
    ...
    for(id aVolume in diskInfo){
        ...
        if (fsDictionary != nil){
            ...
            NSString* volumeTag = [aVolume stringByReplacingOccurrencesOfString:@" " withString:@"\\ "];
            [aMeasurement start:@"DiskInfo" withTags:[NSString stringWithFormat:@"Disk=%@",volumeTag]];
